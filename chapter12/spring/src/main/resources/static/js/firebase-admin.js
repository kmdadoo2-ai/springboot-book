...
(() => {
    ...
    const firebaseConfig = {
        //Firebase -> 프로젝트 설정 -> 일반 -> 내입에서 확인하시면 됩니다.
        const firebaseConfig = {
        apiKey: "웹 앱 설정의 apiKey",
        authDomain: "웹 앱 설정의 authDomain",
        projectId: "웹 앱 설정의 projectId",
        messagingSenderId: "웹 앱 설정의 messagingSenderId",
        appId: "웹 앱 설정의 appId"
    };

    // Firebase 콘솔 → 프로젝트 설정 → Cloud Messaging → 웹 푸시 인증서 → 키 쌍의 공개 키
    const vapidKey = "공개 VAPID 키";
